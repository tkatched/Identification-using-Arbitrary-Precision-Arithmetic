function P = pfhlp(theta1,theta2,msel1,msel2,a,T,n,bc)
...
%% Compute q-alpha
q=(-sqrt(T)*kllp(theta1,theta2,msel1,msel2,n,bc)) + sqrt(vfhlp(theta1,theta2,msel1,msel2,n,bc))*z; %q-alpha
%%
temp=(q-sqrt(T)*kllp(theta2,theta1,msel2,msel1,n,bc))/(sqrt(vfhlp(theta2,theta1,msel2,msel1,n,bc))); %term inside brackets
