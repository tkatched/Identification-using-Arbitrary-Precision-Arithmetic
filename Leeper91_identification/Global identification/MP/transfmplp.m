function X = transfmplp(theta,dir,lb,ub)
%Transformation of parameters for Leeper(1991) model from the unconstrained specification to the
%initial specification and back - replicated from
%Lubik-Schorfheide (2004) Gauss code
...
%ind - index of parameters being transformed

%Parameter order:
%[alpha beta gamma mat mapsi sigt sigpsi]
