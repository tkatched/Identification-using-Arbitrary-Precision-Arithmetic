function [T1,TC,T0,TETA,RC] =sgusolvl4(para,msel)


%Allows solving for MA(2) shock specification in one process, with news in the rest. 
%MA(2) shocks reparameterized as Y_t=theta1*e_t+theta2*e_t-1
%% parameter vector
thet      = para(1);
gam	      = para(2);
kap	      = para(3);
