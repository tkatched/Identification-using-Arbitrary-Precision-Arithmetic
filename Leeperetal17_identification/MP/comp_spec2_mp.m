...
function truespec = comp_spec2_mp(param,x,RegimeM_I)
...
[g0,g1,CC,Psi,Pie,H,C,E,ss,nvar,nexog] = model_mp(param,obs,RegimeM_I);
...
[G,TC,MM,TY,fmat,TZ,TETA,GEV,RC]=gensys_mp2(g0, g1, CC, Psi, Pie, 1); %use Sims-based code, also uses ordqz
