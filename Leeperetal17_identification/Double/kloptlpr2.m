function X = kloptlpr2(thetainput,truespec,x,wg,bc,areg)

%Function to compute the KL distance between Leeper et al (2017) model
...
theta0=thetainput; %parameter to compute spectrum at
...
[g0,g1,CC,Psi,Pie,H,C,E,ss,nvar,nexog] = model(theta0,obs,areg);
