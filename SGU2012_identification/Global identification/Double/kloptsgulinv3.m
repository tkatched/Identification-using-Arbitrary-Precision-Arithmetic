function X = kloptsgulinv3(thetainput,thetab,thetaa,msel2,intsel,truespec,x,wg,bc,parsel,con,wgt,nrm,indp)

%Function to compute the KL distance between SGU (2012) models (observables
%in levels) featuring all news or one shock swithced to an MA unanticipated
%one.
...
[TT,TC,TEPS,TETA,RC] = sgusolvl4(theta0,msel2); %solve model using Sims algorithm
