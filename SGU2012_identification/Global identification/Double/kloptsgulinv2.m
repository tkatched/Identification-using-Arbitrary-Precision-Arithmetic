function X = kloptsgulinv2(thetainput,thetab,thetaa,truespec,x,wg,bc,parsel,con,wgt,nrm,indp)

%Function to compute the KL distance between SGU (2012) models (observables
%in levels) featuring all news or all MA unanticipated shocks
...
[TT,TC,TEPS,TETA,RC] = sgusolvl3(theta0,2); %solve model using Sims algorithm
...
for i=1:nx %compute spectrum
    ...
    spec=(A*mat1*RR*RR'*mat2*A')/(2*pi); %compute spectrum using representation in the paper
