...
% observables in levels (parallel computation of the local id condition)
...
tic;
Gbc=gmatsgulv2(theta0,xbc,wgbc,hd,dif);
t_dbc=toc;
...
tic;
Gbc_mp=gmatsgul_mpv2(theta0mp,xmpbc,wgmpbc,hmp,dif);
t_mpbc=toc;
...
tic;
Gbc_mp50=gmatsgul_mpv2(theta0mp,xmpbc,wgmpbc,hmp,dif);
t_mp50bc=toc;
...
save sgu_local_results_levels_par_bc