...
tic;
Gbc=gmatsguv(theta0,xbc,wgbc,hd,dif);
t_dbc=toc;
...
tic;
Gbc_mp=gmatsgu_mpv(theta0mp,xmpbc,wgmpbc,hmp,dif);
t_mpbc=toc;
...
tic;
Gbc_mp50=gmatsgu_mpv(theta0mp,xmpbc,wgmpbc,hmp,dif);
t_mp50bc=toc;
...
save sgu_local_results_orig_obs_bc