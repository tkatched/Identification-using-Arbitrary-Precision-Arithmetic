% Run the local identification analysis of the SGU (2012) model using the
% original observables (parallel computation)
...
tic;
Gbc=gmatsguv2(theta0,xbc,wgbc,hd,dif);
t_dbc=toc;
...
rankgbc=rank(Gbc);
%[subindbc subeigbc subnamebc]=nsubs(Gbc,ntheta,tolgbc); %find nonidentified subsets
...
save sgu_local_results_orig_obs_par_bc