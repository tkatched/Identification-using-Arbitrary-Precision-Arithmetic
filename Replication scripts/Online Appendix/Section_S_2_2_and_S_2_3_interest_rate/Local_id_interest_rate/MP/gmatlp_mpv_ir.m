function G = gmatlp_mpv(theta0,x,wg,h,dif,msel)
...
if dif==1 %use symmetric Newton's quotient
    ...
    for j=1:ntheta;
        ...
        for i=1:nfreq;
            ...
            tempn=nA*nmat1*nRR*nQQ*nRR'*nmat2*nA'/(pi2);
            tempp=pA*pmat1*pRR*pQQ*pRR'*pmat2*pA'/(pi2);
    ...
    for j=1:ntheta
        ...
        for i=1:nfreq;
            ...
            tempn=nA*nmat1*nRR*nQQ*nRR'*nmat2*nA'/(pi2); %spectra at perturbed theta0
            tempn2=n2A*n2mat1*n2RR*n2QQ*n2RR'*n2mat2*n2A'/(pi2);
            tempp=pA*pmat1*pRR*pQQ*pRR'*pmat2*pA'/(pi2);
            tempp2=p2A*p2mat1*p2RR*p2QQ*p2RR'*p2mat2*p2A'/(pi2);
            nsp_mat(((i-1)*dimy2+1):(i*dimy2),j)=tempn(:); %spectra at perturbed theta0
