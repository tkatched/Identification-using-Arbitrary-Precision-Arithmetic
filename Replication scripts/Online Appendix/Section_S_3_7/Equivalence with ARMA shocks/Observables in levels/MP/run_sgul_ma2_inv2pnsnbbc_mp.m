...
lb=[mp('[0.001 ,7E-06,0.01,0.01,0.00001,-0.99,-0.99,-0.99,-0.99,-0.99,-0.99,-0.99,-0.99]'),[kron(mp(ones(1,7)),mp('[0.01,-6,-4]'))]];
ub=[mp('[15,0.999,35,15,0.999,0.99,0.99,0.99,0.99,0.99,0.99,0.99,0.99]'),[kron(mp(ones(1,7)),mp('[20,6,4]'))]];
