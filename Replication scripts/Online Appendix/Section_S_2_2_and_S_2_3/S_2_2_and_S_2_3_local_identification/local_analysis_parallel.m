...
% The G-matrix code here uses some parallel computation (gmatlpv2.m)
...
tic;
Gampf1=gmatlpv2(theta_ampf1,x,wg,hd,dif,msel); %compute criterion matrix
...
tic;
Gampf1bc=gmatlpv2(theta_ampf1,xbc,wgbc,hd,dif,msel);
tampf1bc=toc;
...
tic;
Gampf1_mp=gmatlp_mpv2(theta_ampf1_mp,xmp,wgmp,hmp,dif,msel);
tampf1_mp=toc;
...
tic;
Gampf1bc_mp=gmatlp_mpv2(theta_ampf1_mp,xmpbc,wgmpbc,hmp,dif,msel);
tampf1bc_mp=toc;
...
tic;
Gampf1_mp50=gmatlp_mpv2(theta_ampf1_mp,xmp,wgmp,hmp,dif,msel);
tampf1_mp50=toc;
...
tic;
Gampf1bc_mp50=gmatlp_mpv2(theta_ampf1_mp,xmpbc,wgmpbc,hmp,dif,msel);
tampf1bc_mp50=toc;
...
tic;
Gampf2=gmatlpv2(theta_ampf2,x,wg,hd,dif,msel); %compute criterion matrix
...
tic;
Gampf2bc=gmatlpv2(theta_ampf2,xbc,wgbc,hd,dif,msel);
tampf2bc=toc;
...
tic;
Gampf2_mp=gmatlp_mpv2(theta_ampf2_mp,xmp,wgmp,hmp,dif,msel);
tampf2_mp=toc;
...
tic;
Gampf2bc_mp=gmatlp_mpv2(theta_ampf2_mp,xmpbc,wgmpbc,hmp,dif,msel);
tampf2bc_mp=toc;
...
tic;
Gampf2_mp50=gmatlp_mpv2(theta_ampf2_mp,xmp,wgmp,hmp,dif,msel);
tampf2_mp50=toc;
...
tic;
Gampf2bc_mp50=gmatlp_mpv2(theta_ampf2_mp,xmpbc,wgmpbc,hmp,dif,msel);
tampf2bc_mp50=toc;
...
tic;
Gpmaf1=gmatlpv2(theta_pmaf1,x,wg,hd,dif,msel);
tpmaf1=toc;
...
tic;
Gpmaf1bc=gmatlpv2(theta_pmaf1,xbc,wgbc,hd,dif,msel);
tpmaf1bc=toc;
...
tic;
Gpmaf1_mp=gmatlp_mpv2(theta_pmaf1_mp,xmp,wgmp,hmp,dif,msel);
tpmaf1_mp=toc;
...
tic;
Gpmaf1bc_mp=gmatlp_mpv2(theta_pmaf1_mp,xmpbc,wgmpbc,hmp,dif,msel);
tpmaf1bc_mp=toc;
...
tic;
Gpmaf1_mp50=gmatlp_mpv2(theta_pmaf1_mp,xmp,wgmp,hmp,dif,msel);
tpmaf1_mp50=toc;
...
tic;
Gpmaf1bc_mp50=gmatlp_mpv2(theta_pmaf1_mp,xmpbc,wgmpbc,hmp,dif,msel);
tpmaf1bc_mp50=toc;
...
tic;
Gpmaf2=gmatlpv2(theta_pmaf2,x,wg,hd,dif,msel);
tpmaf2=toc;
...
tic;
Gpmaf2bc=gmatlpv2(theta_pmaf2,xbc,wgbc,hd,dif,msel);
tpmaf2bc=toc;
...
tic;
Gpmaf2_mp=gmatlp_mpv2(theta_pmaf2_mp,xmp,wgmp,hmp,dif,msel);
tpmaf2_mp=toc;
...
tic;
Gpmaf2bc_mp=gmatlp_mpv2(theta_pmaf2_mp,xmpbc,wgmpbc,hmp,dif,msel);
tpmaf2bc_mp=toc;
...
tic;
Gpmaf2_mp50=gmatlp_mpv2(theta_pmaf2_mp,xmp,wgmp,hmp,dif,msel);
tpmaf2_mp50=toc;
...
tic;
Gpmaf2bc_mp50=gmatlp_mpv2(theta_pmaf2_mp,xmpbc,wgmpbc,hmp,dif,msel);
tpmaf2bc_mp50=toc;
...
tic;
Gind=gmatlpv2(thetaind,x,wg,hd,dif,msel);
tind=toc;
...
tic;
Gindbc=gmatlpv2(thetaind,xbc,wgbc,hd,dif,msel);
tindbc=toc;
...
tic;
Gind_mp=gmatlp_mpv2(thetaind_mp,xmp,wgmp,hmp,dif,msel);
tind_mp=toc;
...
tic;
Gindbc_mp=gmatlp_mpv2(thetaind_mp,xmpbc,wgmpbc,hd,dif,msel);
tindbc_mp=toc;
...
tic;
Gind_mp50=gmatlp_mpv2(thetaind_mp,xmp,wgmp,hmp,dif,msel);
tind_mp50=toc;
...
tic;
Gindbc_mp50=gmatlp_mpv2(thetaind_mp,xmpbc,wgmpbc,hd,dif,msel);
tindbc_mp50=toc;
...
mp.Digits(34); %return back to quadruple precision
%% save results
filename=['local_point_analysis_par_dif',num2str(dif)];
save(filename)
end