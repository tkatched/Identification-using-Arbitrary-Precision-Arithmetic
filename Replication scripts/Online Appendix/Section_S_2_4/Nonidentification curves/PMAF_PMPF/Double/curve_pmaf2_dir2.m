...
if mod(k,1000)==0
    ...
    G=infmatlpi(theta2(k-1,:),x,wg,hd,dif,msel,subind.nsub3(1,:));
...
clear c0 a
theta2(k,:)=theta2(k-1,:)+ [0,he*ctheta2(1:2,k)',0,he*ctheta2(3,k),zeros(1,3),he*ctheta2(4,k),0]; %update parm. vector
gamma=theta2(k,3);
k=k+1;
end
toc;
