%This script verifies that values on the nonidentification curve in Table 3 result
...
%         mp.Digits(pl); %impose precision level
        ...
        resfilename2=[resfilename,'_mp_pmaf1_cdir2_',num2str(jj)];
...
%         if jj<10
        load('curve_pmaf1_dir2','thetacheck')
