%Verifies results for the indeterminacy region with the benchmark model given by PMAF1
%using quadruple precision, imposing zero restrictions on M_r and sunspot
%variance.
...
for kk=1:1
   ...
   for jj=3:3 %consider the noninvertible case
