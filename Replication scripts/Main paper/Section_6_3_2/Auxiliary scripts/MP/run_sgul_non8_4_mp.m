%% Quadruple precision check for global identification of the SGU (2012) model with the 8-period news in the stationary neutral productivity shock shut down.
