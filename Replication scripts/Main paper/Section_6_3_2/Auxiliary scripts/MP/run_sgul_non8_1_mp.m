%% Quadruple precision check for global identification of the SGU (2012) model with the 8-period news in the nonstationary investment-specific productivity shock shut down.
