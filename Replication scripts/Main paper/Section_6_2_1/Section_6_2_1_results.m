%This script replicates the main results in Subsection 6.2 (global identification
%of the medium scale model, Tables 3-4)

clear
%% Global identification of the SGU (2012) model (Subsection 6.2.1)
