...
%identification check of the SGU (2012) model
...
%% Recreate parameter bounds in MP
        lb=[mp('[0.001 ,7E-06,0.01,0.01,0.00001,-0.999,-0.999,-0.999,-0.999,-0.999,-0.999,-0.999,-0.999]'),mp(zeros(1,21))];
        ub=[mp('[15,0.999,35,15,0.999,0.999,0.999,0.999,0.999,0.999,0.999,0.999,0.999]'),mp(ones(1,21))*mp('20')];
        ...
        %Empirical distances:
        ed80=pfhsgul2_mp(thetab,thetaindmp,mp('0.05'),mp('80'),n,bc);
        ed150=pfhsgul2_mp(thetab,thetaindmp,mp('0.05'),mp('150'),n,bc);
        ed200=pfhsgul2_mp(thetab,thetaindmp,mp('0.05'),mp('200'),n,bc);
        ed1000=pfhsgul2_mp(thetab,thetaindmp,mp('0.05'),mp('1000'),n,bc);
                %% Display results
