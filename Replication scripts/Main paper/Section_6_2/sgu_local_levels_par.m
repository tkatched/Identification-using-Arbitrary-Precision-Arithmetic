...
tic;
G=gmatsgulv2(theta0,x,wg,hd,dif); %compute criterion matrix
...
tic;
G_mp=gmatsgul_mpv2(theta0mp,xmp,wgmp,hmp,dif);
t_mp=toc;
valg_mp=eig(G_mp);
...
tic;
G_mp50=gmatsgul_mpv2(theta0mp,xmp,wgmp,hmp,dif);
t_mp50=toc;
...
save sgu_local_results_levels_par