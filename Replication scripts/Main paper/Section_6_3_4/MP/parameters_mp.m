...
set.alphah = mp('0.675');
set.delta0 = mp('0.025');
set.muybar = mp('1.0045');
set.muabar = mp('0.9957');
set.G_Y    = mp('0.2');
set.hbar   = mp('0.2');
set.L      = onep;
set.sig  = onep;
...
set.muw    = set.muwbar;
set.mux    = set.muy*set.mua^(set.alphak/(onep-set.alphak));
set.muxbar = set.mux;
set.mui    = set.mux*set.mua^(onep/(set.alphak-onep));
set.h      = set.hbar;
set.xg     = set.muy^(onep/(param.rhoxg-onep));
