%Verifies results for the indeterminacy region with the benchmark model given by AMPF1
%using quadruple precision

%Specify parameters for search:
parstruc(1,1).ind=[1:10]; %all parameters
mprec=[34,50]; %precision digits considered
...
for kk=1:2
    ...
    for jj=1:1 %consider invertible case
        clearvars -except kk jj parstruc pl mprec
        ...
        bc=0; %choose frequencies: 0 for full spectrum; 1 for business cycle frequencies only
        ...
        clearvars -except breg areg mselb msela thetab parsel invsel resfilename resfilename2 bc kk jj n x wg truespec parstruc pl mprec
