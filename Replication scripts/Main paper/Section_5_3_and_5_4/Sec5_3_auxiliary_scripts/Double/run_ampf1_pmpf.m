%Searches the indeterminacy region with the benchmark model given by AMPF1

%Specify parameters for search:
parstruc(1,1).ind=[1:10]; %all parameters


for kk=1:1 %consider invertible case
    
        clearvars -except jj kk parstruc ns ppool
        ...
        elseif msela==2
            lb2=[0.001 0.001 -5 -5 -5 -5]; % (non)invertibility will be enforced via constraint
