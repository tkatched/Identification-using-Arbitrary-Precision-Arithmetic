%This script verifies that values on the nonidentification curve in Table 1 result
...
%         mp.Digits(pl); %impose precision level
        ...
        resfilename2=[resfilename,'_mp_ampf_cdir2_',num2str(jj)];
...
%         if jj<10
        load('curve_ampf_dir1','thetacheck')
