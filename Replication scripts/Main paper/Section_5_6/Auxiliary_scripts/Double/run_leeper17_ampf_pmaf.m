...
breg=1; %benchmark model regime (only supports AMPF=1, PMAF=2)

areg=2; %objective function will search this regime (supports AMPF=1, PMAF=2, PMPF=3)
...
if runpso==1
    ...
    maxitpso=10000; %maximum number of iterations (similar concept to generations for GA)
